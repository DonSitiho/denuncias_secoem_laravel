...
<body>
    ...
    <div class="folio-section">
        ...
        <div class="folio-number">{{ $denuncia->folio }}</div>
    ...
    <div class="section">
        ...
        <div class="info-item full-width">
            ...
            <div class="value" style="min-height: 80px;">{{ $denuncia->circunstancias_detalladas }}</div>
        </div>
        @endif
    </div>
    ...
    <div class="footer">
        ...
        <p>Folio: {{ $denuncia->folio }} | Generado el: {{ $fechaActual }}</p>
    </div>
</body>
</html>