...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('auth/secoem.svg') }}" class="h-50px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/secoem.svg') }}" class="h-50px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
