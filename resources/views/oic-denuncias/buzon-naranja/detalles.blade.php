<x-default-layout>
    ...
    <x-slot name="header">
        ...
        <a href="{{ route('buzon-naranja.denuncias.index') }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    @if ($denuncia->id_estado == 2)
                        {{-- 1. Botón/Modal de Turno (Permiso: oic-denuncia-turnar) --}}
                        ...
                        @forelse ($denuncia->archivos as $archivo)
                            <div class="d-flex align-items-center bg-light-info rounded p-5 mb-3">
                                ...
                                <span class="ms-2">
                                    ...
                                    @can('oic-denuncia-descargar')
                                        <a href="{{ route('oic.descargar', ['id_archivo' => $archivo->id_archivo]) }}"
