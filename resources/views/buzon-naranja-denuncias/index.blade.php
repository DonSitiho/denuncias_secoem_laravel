<x-default-layout>
    @section('title')
        {{ __('Buzon Naranja Denuncias Nuevas') }}
    @endsection
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">{{ __('Bandeja de Denuncias Nuevas') }}</span>
        ...
        <div class="card-body py-4">
            ...
            --}}
            @livewire('buzon-naranja-denuncias.denuncias-nuevas-table')
        </div>
    </div>
